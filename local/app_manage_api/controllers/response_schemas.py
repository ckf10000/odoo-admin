# -*- coding: utf-8 -*-
"""app_manage_api 响应体 Pydantic 模型"""
...
class PluginUpdateInfo(BaseModel):
    ...
    plugin_name: Optional[str] = Field(default="", description="插件名称")
    ...
    distribution_mode: Optional[str] = Field(default=None, description="分发模式")
    ...
    package_size: Optional[int] = Field(default=None, description="包大小")
...
class VersionCheckInfo(BaseModel):
    ...
    update_url: Optional[str] = Field(default=None, description="更新地址")
    release_note: Optional[str] = Field(default="", description="更新日志")
    package_size: Optional[int] = Field(default=None, description="包大小")
...
class ResourceInfo(BaseModel):
    ...
    force_update: bool = Field(default=False, description="是否强制更新")
    update_interval_hours: Optional[int] = Field(default=None, description="更新间隔小时")
...
class CheckTerminalResponse(BaseModel):
    """检查终端"""
    data: dict = Field(default_factory=dict, description="{allowed: bool, message: str}")
