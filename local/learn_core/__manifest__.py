# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'data/learn_content_source_data.xml',
        'data/learn_word_pos_data.xml',
        'data/learn_word_data_phonics_lesson.xml',
        'data/learn_word_data_g5_hunan_up.xml',
        'data/learn_word_data_g5_hunan_down.xml',
        'data/learn_word_data_g6_hunan_up.xml',
        'data/learn_word_data_g6_hunan_down.xml',
        'data/learn_phrase_data_g5_hunan_up.xml',
        'data/learn_phrase_data_g5_hunan_down.xml',
        'data/learn_phrase_data_g6_hunan_up.xml',
        'data/learn_phrase_data_g6_hunan_down.xml',
        'data/learn_phrase_data_phonics_lesson.xml',
        'data/learn_content_group_data_phonics_lesson.xml',
        'data/learn_content_group_data_g5_english_up_hunan.xml',
        'data/learn_content_group_data_g5_english_down_hunan.xml',
        'data/learn_content_group_data_g6_english_up_hunan.xml',
        'data/learn_content_group_data_g6_english_down_hunan.xml'
    ],
